      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="font-bold text-xl md:text-2xl tracking-tighter text-[var(--white)] flex items-center gap-2 md:gap-3 mb-4 md:mb-6 uppercase text-white">
              <img src="/helima.png" alt="Helima" className="w-10 h-10 md:w-14 md:h-14 object-contain brightness-0 invert" />
              HELIMA
            </Link>
            <p className="text-[var(--white)] opacity-80 max-w-sm leading-relaxed mb-4 md:mb-6 text-sm md:text-base">
              Premium imported products. Simple checkout. WhatsApp support.
            </p>
          </div>
          
          <div>
            <h3 className="text-[var(--white)] font-bold text-base md:text-lg mb-4 md:mb-6 flex items-center gap-2 uppercase tracking-widest">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="https://wa.me/+2348166707276" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 hover:text-[var(--gold)] transition-colors inline-block uppercase text-sm">WhatsApp Support</a></li>
        ...
        <div className="border-t border-[var(--white)] border-opacity-20 mt-10 md:mt-16 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
        ...
        <div className="mt-4 text-center text-[10px] md:text-xs opacity-50 tracking-widest border-t border-[var(--white)] border-opacity-10 pt-2">
          Developed by <a href="https://www.blimtechnologies.com" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--gold)] transition-colors font-bold text-white">Blim Technologies</a>
        </div>
      </div>
    </footer>
  );
