  ...
  return (
    <div className="solid-card group flex flex-col h-full relative bg-[var(--white)]">
      <div className="relative aspect-square w-full overflow-hidden border-b border-[var(--navy)]">
        ...
        <div className="absolute inset-0 bg-[var(--navy)] bg-opacity-0 group-hover:bg-opacity-10 transition-colors duration-300 flex items-end justify-center p-4 opacity-0 group-hover:opacity-100">
          <button className="w-full bg-[var(--navy)] text-[var(--white)] py-3 px-4 font-bold uppercase tracking-widest text-sm border-2 border-[var(--navy)] hover:bg-[var(--white)] hover:text-[var(--navy)] transition-colors">
            Quick Add
          </button>
        </div>
      </div>
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-6 flex items-center justify-between border-t border-[var(--navy)] pt-4">
          ...
          <button className="w-10 h-10 border-2 border-[var(--navy)] flex items-center justify-center text-[var(--navy)] hover:bg-[var(--navy)] hover:text-[var(--white)] transition-colors">
