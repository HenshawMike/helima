...
export default function LoginPage() {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-[var(--white)] text-[var(--navy)]">Loading...</div>;
  }
        ...
        <ScrollReveal>
          <div className="border-4 border-[var(--navy)] p-12 text-center">
            ...
            <button 
              ...
              className="w-full bg-[var(--white)] text-[var(--navy)] py-4 font-black uppercase tracking-widest text-sm border-2 border-[var(--navy)] hover:bg-[var(--navy)] hover:text-[var(--white)] transition-colors flex items-center justify-center gap-3 mb-6"
            >
