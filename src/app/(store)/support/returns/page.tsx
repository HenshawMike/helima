        ...
        <div className="space-y-8 md:space-y-12">
          ...
          <ScrollReveal delay={600}>
            <section className="border-l-4 border-[var(--gold)] pl-6">
              ...
              <button className="bg-[var(--navy)] text-[var(--white)] px-6 py-3 md:px-8 md:py-4 font-black uppercase tracking-widest text-xs hover:bg-[var(--gold)] transition-colors">
                Initiate Return →
              </button>
            </section>
          </ScrollReveal>
