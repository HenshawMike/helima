        ...
        <div className="space-y-12">
          <ScrollReveal delay={200}>
            <section className="border-l-4 border-[var(--navy)] pl-6">
              <h2 className="text-2xl font-black text-[var(--navy)] uppercase tracking-tighter mb-4">Domestic Shipping</h2>
          ...
          <ScrollReveal delay={400}>
            <section className="border-l-4 border-[var(--navy)] pl-6">
              <h2 className="text-2xl font-black text-[var(--navy)] uppercase tracking-tighter mb-4">International Imports</h2>
              <p className="text-[var(--navy)] opacity-80 leading-relaxed">
          ...
          <ScrollReveal delay={600}>
            <section className="border-l-4 border-[var(--gold)] pl-6">
              <h2 className="text-2xl font-black text-[var(--navy)] uppercase tracking-tighter mb-4">Tracking & Updates</h2>
              <p className="text-[var(--navy)] opacity-80 leading-relaxed">
