...
export default function CartClient() {
  const { items, updateQuantity, removeItem, totalPrice, pricesUpdated, dismissPriceNotice } = useCart();
        ...
        {pricesUpdated && (
          <div className="mb-6 p-4 border-2 border-[var(--gold)] bg-[#fffdf5] flex items-center justify-between gap-4">
            <p className="text-[var(--navy)] font-bold text-xs md:text-sm uppercase tracking-wider">
              ⚠️ Some item prices have been updated to reflect the latest catalogue prices.
            </p>
            <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-16">
            ...
            <div className="lg:col-span-1">
              <ScrollReveal delay={300} direction="right">
                <div className="bg-[var(--navy)] text-[var(--white)] p-5 md:p-8 border-4 border-[var(--navy)] relative text-left">
