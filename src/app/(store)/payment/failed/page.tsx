  ...
  return (
    <div className="bg-[var(--white)] min-h-screen pt-32 pb-32 flex flex-col items-center justify-center text-center">
      <div className="max-w-xl mx-auto px-4 sm:px-6 w-full">
        <ScrollReveal>
          <div className="w-24 h-24 border-4 border-[var(--gold)] rounded-full flex items-center justify-center mx-auto mb-8">
            <svg className="w-12 h-12 text-[var(--gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
